...
def map_xy_to_lat_lon(x, y, lambda_ctr):
    '''
...
def utm_xy_to_lat_lon(x, y, zone, southhemi):
    '''
    ...
    latlon = map_xy_to_lat_lon(x, y, cmeridian);
...
def utm_to_lat_lon(x, y, zone, hemi):
    '''
    ...
    # Convert
    latlon = utm_xy_to_lat_lon(x, y, zone, southhemi)
